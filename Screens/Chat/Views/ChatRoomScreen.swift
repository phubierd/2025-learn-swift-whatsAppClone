    ...
    var body: some View {
        MessageListView(viewModel)
            ...
            .photosPicker(
                ...
                maxSelectionCount: 6,
                // add this to add itemIdentifier of photo picker!!!! (case remove img from preview)
                photoLibrary: .shared()
            )
    ...
    private func bottomSafeAreaView()->some View{
        VStack(spacing:0){
            ...
            TextInputArea(textMessage: $viewModel.textMessage,
                          ...
                          elapsedTime: $viewModel.elaspedVoiceMessageTime) { action in
...
#Preview {
    NavigationStack {
        ChatRoomScreen(channel: ChannelItem.placeholder)
    }
}
